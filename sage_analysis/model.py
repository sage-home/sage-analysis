...
class Model(object):
    ...
    def __init__(
        ...
        sage_output_format : str, optional
            If not specified will use the output format read from ``sage_file``.
        ...
        num_sage_output_files : int, optional
            ...
            range specified by [first_file, last_file].
        ...
        if num_sage_output_files is None and sage_output_format is "sage_binary":
            msg = "When analysing binary SAGE output, the number of output files generated by SAGE must be specified."
