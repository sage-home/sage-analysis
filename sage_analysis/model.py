...
class Model(object):
    ...
    def __init__(
        ...
        first_file_to_analyse: int,
        last_file_to_analyse: int,
        ...
        num_sage_output_files : int, optional
            ...
            range specified by [first_file_to_analyse, last_file_to_analyse].
        ...
        self._snapshot = snapshot_to_plot
        self._IMF = IMF
        self._label = label
        self._sage_output_format = sage_output_format
        self._first_file_to_analyse = first_file_to_analyse
        ...
        if num_sage_output_files is None and sage_output_format is "sage_binary":
            raise RuntimeError(
    ...
    def volume(self):
        ...
        number of files processed, ``[:py:attr:`~first_file_to_analyse`, :py:attr:`~last_file_to_analyse`]``,
    ...
    def sage_data_path(self) -> str:
        ...
        [:py:attr:`~first_file_to_analyse`, :py:attr:`~last_file_to_analyse`] inclusive.
        """
    ...
    def __repr__(self):
        ...
        string = "========================\n" \
                ...
                f"First file to read: {self._first_file_to_analyse}\n" \
                f"Last file to read: {self._last_file_to_analyse}\n" \
                 "========================"
    ...
    def calc_properties_all_files(
        ...
        for file_num in range(self.first_file_to_analyse, self.last_file_to_analyse + 1):
